...
int long_tramo_par_mas_largo(int v[], int n) {
    ...
    /*
    Para este tipo de ejercicios se maneja un espacio [inicio, fin] dentro del vector, donde SIEMPRE hay que avanzar el punto
    inicio o el fin para asegurar una complejidad y desarrollo correctos.
    Para este ejercicio concreto, se va ampliando la ventana si todo el tramo [inicio, fin] contiene pares. En el momento en que
    encuentra un valor impar, cierra totalmente la ventana a [inicio = fin, fin], y busca el tramo de pares mas largo
    */
    while(fin < n){
