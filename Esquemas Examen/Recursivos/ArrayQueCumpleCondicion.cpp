...
/*
Para este tipo de problemas dividimos el problema en dos y revisamos las caracteristicas de las dos 
mitades en funcion de lo que pida el ejercicio. Para estos ejercicios es habitual devolver mas de un dato,
por lo que es mucho mejor crear una estructura con todos los datos de salida en vez de pasar todo por referencia.
Y SIEMPRE retornar informacion de todas las variables de salida aunque para X segmento no nos interese evaluar un valor
Para este ejercicio concreto se dice que un vector es parcurioso si la mitad izquierda tiene menos o igual pares que la 
cantidad de impares del segmento derecho, y que la suma de pares de la izquierda sea menor o igual que la suma de impares de la derecha
y que una de las dos mitades sean parcuriosas
*/
